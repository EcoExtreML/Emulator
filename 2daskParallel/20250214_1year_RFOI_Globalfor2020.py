...
LAI_PATH = f'{DATA_DIR}/{year}global/lai_v2/lai_v2_{year}wholeyear.zarr'
...
LEH_PATH = f'/projects/0/einf2480/fluxhourly/global_fluxes_RFOI_{year}-{month:02d}_v1.3.zarr'
